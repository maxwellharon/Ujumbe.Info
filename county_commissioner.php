...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="county_commissioner.php"><span><?php $qury="select county from county  where county='$place'"; 
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<li><a href="county_commandant.php"><span class="glyphicon glyphicon-user"></span>County Messeges</a></li>	  	
		...
		<li><a href="county_commissioner.php?view=const"><span class="glyphicon glyphicon-user"></span>Constituency Messeges</a></li>	  	
		<li role="presentation" class="divider"></li>
				...
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-13 col-lg-7 widget-right">
							<div  class="head"><strong><?php $qury="select county_commissioner from county where county='$place'"; 
						 $result= mysql_query($qury);
						while($data=mysql_fetch_assoc($result)){
                          echo $data['county_commissioner'];
						}
							?></strong></div>
