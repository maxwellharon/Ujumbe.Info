	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="president.php"><span>
				<?php echo $place;?>
                          </span>
                          </a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<li role="presentation" class="divider"></li>-->
		 ...
		 <a href='specific-messages.php'>"; ?><span class="glyphicon glyphicon-envelope"></span> </span>All Messages
		  <span class="badge"><?php $result=mysql_query("SELECT count(*) as total from ujumbemessages join ujumbe_users on ujumbe_users.msisdn= ujumbemessages.msisdn join constituency on ujumbe_users.constituency=constituency.const_Id join county on constituency.cont_Id=county.id  where  ujumbemessages.message<>''and ujumbemessages.repId=1" );
          $data=mysql_fetch_assoc($result);
		 ...
		 <span class="badge"><?php $result=mysql_query("SELECT count(*) as total from ujumbemessages join ujumbe_users on ujumbe_users.msisdn= ujumbemessages.msisdn join issue on ujumbemessages.issueId=issue.id join constituency on ujumbe_users.constituency=constituency.const_Id join county on constituency.cont_Id=county.id  where issue.id='".$issue['id']."'and ujumbemessages.message<>''and ujumbemessages.repId=1 
		 " );
          $data=mysql_fetch_assoc($result);
          echo $data['total'];?></span></a>
