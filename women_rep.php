...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="women_rep.php"><span><?php $qury="select county from county  where county='$place'"; 
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<li><a href="women_rep.php"><span class="glyphicon glyphicon-user"></span>County Messeges</a></li>	  	
		...
		<li><a href="women_rep.php?view=const"><span class="glyphicon glyphicon-user"></span>Constituency Messeges</a></li>	  	
		<li role="presentation" class="divider"></li>
		 <li> <?php
		 echo"
				...
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-13 col-lg-7 widget-right">
							<div  class="head"><strong><?php $qury="select women_rep from county where county='$place'"; 
						 $result= mysql_query($qury);
						while($data=mysql_fetch_assoc($result)){
                          echo $data['women_rep'];
						}
							...
							<div class="text-muted"><?php $qury="select party_women_rep from county where county='$place'"; 
						 $result= mysql_query($qury);
						while($data=mysql_fetch_assoc($result)){
                          echo $data['party_women_rep'].' '.'Party';
						}
							?>
                            </div>
					</div>
