	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="parent ">
            	...
            	<li><a href="dagonorthA.html"><span class="glyphicon glyphicon-th"></span>  Analytics</a></li>
              
			
        <li><a href="dagonorthM.php"><span class="glyphicon glyphicon-comment"></span> Messages</a></li>
