...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="../Dashboard.html"><span class="glyphicon glyphicon-eye-close"></span> Nairobi Dashboard</a></li>
			<li class="parent ">
            	...
            	<li><a href="west-analytics.html"><span class="glyphicon glyphicon-th"></span>  Analytics</a></li>
              
			
        <li><a href="west-messages.php"><span class="glyphicon glyphicon-comment"></span> Messages</a></li>
