						        ...
						        <th data-field="number" data-sortable="true"> Phone Number</th>
								       ...
								       <th data-field="message" data-sortable="true">Issue</th>
									    <th data-field="date" data-sortable="true">Date created</th>
										            <th data-field="constituency" data-sortable="true">County</th>
						    </tr>
						    </thead>
							<tbody>
							<?php
       
        $query="select firstname,secondName, gender,age, msisdn,message,county,ujumbemessages.dateCreated from ujumbe_users join ujumbemessages on ujumbe_users.Id= ujumbemessages.userId join constituency on ujumbe_users.constituency=constituency.const_Id join county on county.id=constituency.cont_id ";
  ...
  while($row=mysql_fetch_array($sql))
{
 ...
 $location=$row['county'];
  ...
  <td><a href='message.php?id=$datecreated'>". $fname."</a> </td>
    ...
    <td> ".$issue." </td>
     <td> ".$datecreated ."</td>
	 <td><a href='category-msgs.php?county=$location'>".$location."</td>
	 </tr>";
	 }
?>
