...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>Constituency</span>Admin</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <li><a href="messages-constituency.php"><span class="glyphicon glyphicon-envelope"></span> Messages
		 <span class="badge"><?php $result=mysql_query("SELECT count(*) as total from  ujumbemessages  join ujumbe_users on ujumbe_users.Id= ujumbemessages.userId join constituency on ujumbe_users.constituency=constituency.const_Id");
...
echo $data['total'];?></span>
  ...
  <li ><a href="messages-county.php"><span class="glyphicon glyphicon-comment"></span> Messages </a></li>
        ...
        $query1="select firstname,secondName, gender,age, msisdn,constituency.constituency from ujumbe_users join constituency on ujumbe_users.constituency=constituency.const_Id";
