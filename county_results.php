...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		$query=mysql_query("select firstname,secondName, gender,age, ujumbemessages.msisdn,constituency.constituency,issue,ujumbemessages.issueId,ujumbemessages.id,  ujumbemessages.dateCreated from issue join ujumbemessages on issue.id= ujumbemessages.issueId join ujumbe_users on ujumbe_users.msisdn= ujumbemessages.msisdn join constituency on ujumbe_users.constituency=constituency.const_Id join county on constituency.cont_Id=county.id  where county.id='".$_GET['county']."' and ujumbemessages.message<>'' ");
