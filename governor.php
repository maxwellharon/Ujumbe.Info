...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="governor.php"><span><?php $qury="select county from county where county='$place'"; 
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<li><a href="governor.php"><span class="glyphicon glyphicon-user"></span>County Messeges</a></li>	  	
		...
		<li><a href="governor.php?view=const"><span class="glyphicon glyphicon-user"></span>Constituency Messeges</a></li>	  	
		<li role="presentation" class="divider"></li>
				...
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-13 col-lg-7 widget-right">
							<div  class="head"><strong><?php $qury="select honorable_governor from county where county='$place'"; 
						 $result= mysql_query($qury);
						while($data=mysql_fetch_assoc($result)){
                          echo $data['honorable_governor'];
						}
							?></strong></div>
                            
							<div class="text-muted"><?php $qury="select party_governor from county where county='$place'"; 
						 $result= mysql_query($qury);
						while($data=mysql_fetch_assoc($result)){
                          echo $data['party_governor'].' '.'Party';
						}
							?>
                            </div>
					</div>
