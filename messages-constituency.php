...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
		 ...
		 <span class="badge"><?php $result=mysql_query("SELECT count(*) as total from  ujumbemessages  join ujumbe_users on ujumbe_users.Id= ujumbemessages.repId join constituency on ujumbe_users.constituency=constituency.const_Id");
...
window.onload = function(){
	...
	<div class="row">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Constituency Messages</div>
					<div class="panel-body">
						<table data-toggle="table"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
							...
							<?php
                 ;
        $query="select firstname,secondName, gender,age, msisdn,constituency.constituency,message,  ujumbemessages.dateCreated from ujumbe_users join ujumbemessages on ujumbe_users.Id= ujumbemessages.userId join constituency on ujumbe_users.constituency=constituency.const_Id";
  ...
  while($row=mysql_fetch_array($sql))
{
  ...
  <td><a href='message.php?id=$datecreated'>". $fname."</a> </td>
    ...
    <td> ".$issue." </td>
     <td> ".$datecreated ."</td>
	 	<td><a href='specific-messages.php?constituency=$location'>". $location."</a> </td>
	 </tr>";
	 }
?>
