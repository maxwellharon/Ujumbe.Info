...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			...
			<label class="control-label" for="response">Select County </label>				

<select name="forma" onchange="location = this.options[this.selectedIndex].value;">
<option selected></option>
 <?php
  
    $result = mysql_query("SELECT id,county from county ")or die(mysql_error());
    while ($row=mysql_fetch_array($result)){?>
    
 <option value="county_results.php?county=<?php echo $row['id']; ?>"><?php echo $row['county']; ?></option>
 <?php } ?>
</select>
