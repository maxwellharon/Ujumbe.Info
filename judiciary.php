...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<li><a href="judiciary.php"><span class="glyphicon glyphicon-user"></span>County Messeges</a></li>	  	
		...
		<li><a href="judiciary.php?view=const"><span class="glyphicon glyphicon-user"></span>Constituency Messeges</a></li>	  	
		<li role="presentation" class="divider"></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
				...
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-13 col-lg-7 widget-right">
							<div  class="head"><strong><?php $qury="select county_commandant from county where county='$place'"; 
						 $result= mysql_query($qury);
						while($data=mysql_fetch_assoc($result)){
                          echo Judiciary;
						}
        ...
        $query1="select firstname,secondName, gender,age, msisdn,constituency.constituency as constituency  from ujumbe_users join constituency on ujumbe_users.constituency=constituency.const_Id  join county on constituency.cont_Id=county.id  where county.county='".$_SESSION['username']."'";
