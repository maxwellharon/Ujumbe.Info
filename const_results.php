...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<span class="glyphicon glyphicon-envelope"></span> </span> All Messages
		  
		  <span class="badge"><?php $result=mysql_query("SELECT count(*) as total from ujumbemessages join ujumbe_users on ujumbe_users.msisdn= ujumbemessages.msisdn join constituency on ujumbe_users.constituency=constituency.const_Id join county on constituency.cont_Id=county.id  where  ujumbemessages.message<>''and constituency.const_Id='".$_GET['constituency']."' " );
          $data=mysql_fetch_assoc($result);
          echo $data['total'];?></span> 
		...
		$query=mysql_query("select firstname,secondName, gender,age, ujumbemessages.msisdn,constituency.constituency,issue,ujumbemessages.issueId,ujumbemessages.id,  ujumbemessages.dateCreated from issue join ujumbemessages on issue.id= ujumbemessages.issueId join ujumbe_users on ujumbe_users.msisdn= ujumbemessages.msisdn join constituency on ujumbe_users.constituency=constituency.const_Id join county on constituency.cont_Id=county.id  where constituency.const_Id='".$_GET['constituency']."' and ujumbemessages.message<>'' ");
